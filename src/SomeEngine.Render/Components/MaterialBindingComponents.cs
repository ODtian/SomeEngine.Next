...
public readonly record struct MeshMaterialBinding(AssetHandle<Material> Material) : IBufferElement;
...
/// </summary>
public readonly record struct RenderMaterialBinding(AssetHandle<Material> Material) : IBufferElement;
