...
{
    [Fact]
    public void Structurally_identical_publication_preserves_snapshot_identity_and_version()
    {
        ...
        uint shadeBin)
    {
        ...
        return new ClusterMaterialSnapshot(
            [new MaterialSequence([material], 0)],
            [material],
            words,
            slotCapacity);
    }
